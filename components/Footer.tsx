        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/info" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Real Test Info
                </Link>
              </li>
              <li>
                <Link href="/schedule" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Schedule
                </Link>
              </li>
              <li>
                <Link href="/syllabus" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Syllabus
                </Link>
              </li>
            </ul>
